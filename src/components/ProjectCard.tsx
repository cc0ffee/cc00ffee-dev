function ProjectCard(props: {image: any, title: string, languages: string, description: string, isPersonal: boolean, link: string}) {
    ...
    return <div className='max-w-sm rounded overflow-hidden border border-gray-300 dark:border-gray-600 m-2'>
        ...
        <div className="px-6 py-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm mb-2">{ props.languages }</p>
            <p className="text-gray-700 dark:text-gray-100 text-base mb-2">{ props.description }</p>
